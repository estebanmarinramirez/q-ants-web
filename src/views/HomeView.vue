  ...
  const news = ref([
    {
      ...
      summary:
        'Latest technical analysis indicates a bullish trend in technology stocks, with key resistance levels being tested.',
    ...
    },
    {
      ...
      summary:
        'A new mean reversion strategy has been added to the strategy builder. Test it with historical data now.',
    ...
    },
    {
      ...
      summary:
        'Market conditions suggest an optimal time for portfolio rebalancing. Click to view detailed analysis.',
